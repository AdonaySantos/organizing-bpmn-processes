...
export default function Admin() {
  ...
  const [userAccess, setUserAccess] = useState([
    { id: 1, name: 'User1', accessType: 'Admin', accessDate: '2024-11-01' },
    { id: 2, name: 'User2', accessType: 'User', accessDate: '2024-11-02' },
    { id: 3, name: 'User3', accessType: 'Admin', accessDate: '2024-11-03' },
    { id: 4, name: 'User4', accessType: 'User', accessDate: '2024-11-04' },
    { id: 5, name: 'User5', accessType: 'Admin', accessDate: '2024-11-05' },
    { id: 6, name: 'User6', accessType: 'User', accessDate: '2024-11-06' },
    { id: 7, name: 'User7', accessType: 'Admin', accessDate: '2024-11-07' },
    { id: 8, name: 'User8', accessType: 'User', accessDate: '2024-11-08' },
  ]);

  // Estado para contagem de acessos
  const [accessCount, setAccessCount] = useState({ Admins: 0, Users: 0 });
  ...
  useEffect(() => {
    const count = { Admins: 0, Users: 0 };
    userAccess.forEach((user) => {
      if (user.accessType === 'Admin') count.Admins += 1;
      if (user.accessType === 'User') count.Users += 1;
    });
            ...
            <div className="table-body">
              <table>
                <tbody>
                  <tr>
                    <td>Admins</td>
                    <td>{accessCount.Admins}</td>
                  </tr>
                  <tr>
                    <td>Users</td>
                    <td>{accessCount.Users}</td>
                  </tr>
                </tbody>
              </table>
            </div>
